...
namespace D3G
{
    ...
    struct Renderer2DStorage
    {
        ...
        D3GVertex *QuadVertexBufferBase = nullptr;
        D3GVertex *QuadVertexBufferPtr = nullptr;

        D3GVertex *TriangleVertexBufferBase = nullptr;
        D3GVertex *TriangleVertexBufferPtr = nullptr;

        D3GVertex *PointVertexBufferBase = nullptr;
        D3GVertex *PointVertexBufferPtr = nullptr;


        D3GVertex *LineVertexBufferBase = nullptr;
        D3GVertex *LineVertexBufferPtr = nullptr;
    ...
    void Renderer2D::InitTriangles()
    {
        ...
        s_Storage.TriangleVertexBufferBase = new D3GVertex[Renderer2DStorage::MaxTrianglesVertices];
    ...
    void Renderer2D::InitLines()
    {
        ...
        s_Storage.LineVertexBufferBase = new D3GVertex[Renderer2DStorage::MaxLinesVertices];
    ...
    void Renderer2D::InitPoints()
    {
        ...
        s_Storage.PointVertexBufferBase = new D3GVertex[Renderer2DStorage::MaxPointsVertices];
